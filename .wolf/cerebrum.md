...
## Key Learnings
- **usbipd-win 5.3 WSL attachment syntax:** use `usbipd attach --wsl --busid <BUSID>`; it attaches to all WSL 2 distributions and selecting one is unnecessary. Do not run a distribution-specific Bash probe afterward because `docker-desktop` has no Bash.
